...
class MyApp(QDialog):
    ...
    def initUI(self):
        ...
        # 풀버젼
        # pyinstaller --hidden-import PyQt5 --hidden-import pyserial --hidden-import requests --hidden-import chardet --add-data="C:\\my_games\\pracia\\data_pracia;./pracia" --add-data="C:\\my_games\\pracia\\mysettings;./mysettings" --name pracia -i="pracia_icon.ico" --add-data="pracia_icon.ico;./" --icon="pracia_icon.ico" --paths "C:\Users\1_S_3\AppData\Local\Programs\Python\Python311\Lib\site-packages\cv2" main.py
        # 업데이트버젼
        # pyinstaller --hidden-import PyQt5 --hidden-import pyserial --hidden-import requests --hidden-import chardet --add-data="C:\\my_games\\pracia\\data_pracia;./pracia" --name pracia -i="pracia_icon.ico" --add-data="pracia_icon.ico;./" --icon="pracia_icon.ico" --paths "C:\Users\1_S_3\AppData\Local\Programs\Python\Python311\Lib\site-packages\cv2" main.py
